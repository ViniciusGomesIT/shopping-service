...
public enum GroupType {
    ...
    FOOD(asList(SUCO, OVO, LASANHA, IOGURTE, MACARRAO, GRANOLA, QUEIJO, SOPA, CUSCUZ, PIPOCA, AZEITE, REQUEIJAO, ARROZ, CAFE, MANDIOCA, FEIJAO, PAO, LEITE, AVEIA, BATATA_DOCE, PIZZA,
            GOMA_TAPIOCA, MANTEIGA, CHA, ACUCAR, AGUA, SAL, BATATA, CREME_LEITE, ACHOCOLATADO)),
    ...
    MEAT(asList(FRANGO, BACON, ALCATRA, CAMARAO, LINGUICA, EMPANADO, CHARQUE, CEBOLINHA_VERDE, BIFE, FRALDINHA, BISTECA, COXAO_DURO)),
